<x-vendedor-layout :title="'Nuevo en ' . $agencia->nombre" :back="route('vendedor.vehiculos.index', $agencia)">

<form method="POST" action="{{ route('vendedor.vehiculos.store', $agencia) }}"
