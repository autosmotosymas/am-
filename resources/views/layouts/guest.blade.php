...
<body class="font-sans antialiased bg-[#111111] min-h-screen flex flex-col">
    ...
    <div class="flex-1 flex flex-col md:flex-row">
        ...
        <div class="hidden md:flex md:w-1/2 lg:w-[55%] bg-gradient-to-br from-[#0d0d0d] via-[#1a0f00] to-[#111111] p-10 flex-col justify-between relative overflow-hidden">
            ...
            <a href="{{ route('home') }}" class="relative">
                <img src="{{ asset('img/logo_amm.png') }}" alt="AutosMotosYMás" class="h-10 w-auto">
            </a>
