    ...
    <form method="POST" action="{{ route('admin.certificaciones.update', $cert) }}"
        ...
        <div>
            ...
            <textarea name="observaciones" rows="3"
                      class="w-full bg-card2 border border-base text-base text-sm rounded-xl px-3 py-2.5 focus:outline-none focus:border-brand-orange transition-colors resize-none @error('observaciones') border-red-500/60 @enderror">{{ old('observaciones', $cert->observaciones) }}</textarea>
