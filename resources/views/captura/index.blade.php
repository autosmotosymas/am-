<x-captura-layout title="Mi lista">
    ...
    <div class="px-4 pt-5">
        ...
        <div class="mb-5">
            ...
            <p class="text-xs text-gray-600 mt-0.5">
                {{ $vehiculos->total() }} {{ Str::plural('vehículo', $vehiculos->total()) }} capturado{{ $vehiculos->total() !== 1 ? 's' : '' }} en total
            </p>
        </div>
        ...
        @if($vehiculos->isEmpty())
            <div class="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p class="text-white font-semibold mb-1">Sin capturas aún</p>
                <p class="text-sm text-gray-500 mb-6 max-w-xs">
                    Toca el botón <span class="text-brand-orange">+</span> para registrar el primer vehículo.
                </p>
                <a href="{{ route('captura.create') }}" class="btn-primary">
                    Capturar vehículo
                </a>
            </div>
        @else
